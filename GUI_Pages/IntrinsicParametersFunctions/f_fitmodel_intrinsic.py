import numpy as np
from GUI_Pages.IntrinsicParametersFunctions.calc_diff_intrinsic import calc_diff_intrinsic
from GUI_Pages.IntrinsicParametersFunctions.f_ps_intrinsic import f_ps_intrinsic
