...
class Widget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.videoFolder = 'videos/wellPlateImages/'
        self.framesList = os.listdir(self.videoFolder)
        ...
        # print(self.videoFolder + self.framesList[0])
        # self.pixmapItem = QGraphicsPixmapItem(QPixmap(self.videoFolder + self.framesList[0]))
        # self._scene.addItem(self.pixmapItem)

        imageviewer = ImageViewer()
        imageviewer.setPixmap(QPixmap(self.videoFolder + self.framesList[0]))
        self._scene.addWidget(imageviewer)
    ...
    def initializePlayer(self, url):
        ...
        # This was temp added
        newWidth, newHeight = calculateMaximumSize((self.width, self.height),
